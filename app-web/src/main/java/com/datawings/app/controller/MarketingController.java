...
@Controller
@SessionAttributes({ "marketingFilter" })
public class MarketingController {
	...
	public String postRdv(@ModelAttribute("marketingFilter") MarketingFilter filter, Model model, HttpServletRequest request) throws ServletRequestBindingException {
		...
		if(StringUtils.equals(action, "CREATE")){
			...
			marketing.setFullName(filter.getFullNameCreate().toUpperCase());
			...
			marketing.setStatus(DentalUtils.status_NOTYET);
			...
			marketing.setFullName(filter.getFullNameEdit().toUpperCase());
